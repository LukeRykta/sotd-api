...
class ListeningStreaksServiceTest {
    ...
    void getListeningStreaksReturnsComputedInsights() {
        ...
        when(repository.findDailyTrackRollups(7L, LocalDate.parse("2025-12-19"), LocalDate.parse("2026-03-19")))
                .thenReturn(List.of(
                        new DailyTrackRollup(LocalDate.parse("2026-03-14"), "track-a", "Track A", 2, Instant.parse("2026-03-14T12:00:00Z")),
                        new DailyTrackRollup(LocalDate.parse("2026-03-15"), "track-a", "Track A", 3, Instant.parse("2026-03-15T12:00:00Z")),
                        new DailyTrackRollup(LocalDate.parse("2026-03-16"), "track-a", "Track A", 4, Instant.parse("2026-03-16T12:00:00Z")),
                        new DailyTrackRollup(LocalDate.parse("2026-03-16"), "track-b", "Track B", 5, Instant.parse("2026-03-16T13:00:00Z")),
                        new DailyTrackRollup(LocalDate.parse("2026-03-18"), "track-b", "Track B", 6, Instant.parse("2026-03-18T12:00:00Z"))
                ));
